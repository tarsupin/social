...
/****** Get The User's Clearance for the Social Page ******/
	...
	(
		$uniID				// <int> The ID of the user to check clearance for.
	,	$viewClearance		// <int> The clearance level for viewing: 2=follower, 6=friend
	,	$interactClearance	// <int> The clearance level for interaction: 6=friend
	,	$permissions		// <array> An array of permissions granted by the social page.
	)						// RETURNS <str:bool> the clearance the user has on this page.
...
/****** Display a Social Wall Feed ******/
	...
	(
		$socialPosts	// <int:[str:mixed]> The data that contains all of the social posts.
	,	$clearance		// <str:bool> The clearance levels for the page.
