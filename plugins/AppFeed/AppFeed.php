...
/****** Update The User's Feed ******/
	...
	(
		$uniID			// <int> The Uni-ID to return feeds to.
	)					// RETURNS <void> PREPARES the list of feeds for the user routinely.
...
/****** Retrieve a list of posts from your feed ******/
	...
	(
		$uniID			// <int> The Uni-ID to get the feed for.
	,	$sortType = 0	// <int> 0 will sort by most relevant, 1 sorts by most recent
	)					// RETURNS <int:[str:mixed]> a list of posts from your feed.
...
/****** Check the last time the feed was updated ******/
	...
	(
		$uniID			// <int> The Uni-ID to check the last feed update was at.
	)					// RETURNS <int> the timestamp of your last update, or 0 if never.
