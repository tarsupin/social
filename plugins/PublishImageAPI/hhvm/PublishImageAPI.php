...
------------------------------
	...
	,	'image_url'		=> $imageURL	// The image URL that you're posting (often an article-like thumbnail)
	...
	Connect::to("social", "PublishImageAPI", $packet);
...
class PublishImageAPI extends API {
...
/****** Run the API ******/
	...
	// $this->runAPI()
	{
		...
		$attachment = new Attachment(Attachment::TYPE_IMAGE, Sanitize::url($this->data['image_url']));
