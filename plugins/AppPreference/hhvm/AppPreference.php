...
/****** Create a Preference ******/
	...
	(
		string $group			// <str> The preference group. (e.g. "Food and Drink").
	,	string $preference		// <str> The preference (e.g. "Pizza", "Ice Cream").
	): bool					// RETURNS <bool> TRUE if exists, FALSE on failure.
...
/****** Get the weight of a User's Preference of something ******/
	...
	,	string $preference		// <str> The preference (e.g. "Pizza", "Ice Cream").
	): int					// RETURNS <int> weight of the preference, FALSE if not tracked.
...
/****** Get the weight of a User's Preferences within a chosen preference group ******/
	...
	(
		int $uniID			// <int> The UniID of the user.
	,	string $group			// <str> The preference group to retrieve.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> a list of preferences (and their corresponding weight)
...
/****** Update weights after a User makes a choice between two preferences ******/
	...
	(
		int $uniID			// <int> The UniID of the user.
	,	string $preference1	// <str> The first preference to compare (e.g. "Pizza").
	,	string $preference2	// <str> The second preference to compare (e.g. "Ice Cream").
	,	int $choice			// <int> The choice (1 for first, 2 for second, 0 for neither, 3 for both).
...
/****** Run the weight-boost algorithm ******/
	...
	(
		float $winWeight		// <float> the weight of the winning preference.
	,	float $loseWeight		// <float> the weight of the losing preference.
	): float					// RETURNS <float> the amount of boost to provide, FALSE on failure.
...
/****** Set a User's Preference of something ******/
	...
	(
		int $uniID			// <int> The UniID of the user.
	,	string $preference		// <str> The preference (e.g. "Pizza", "Ice Cream").
	,	int $weight			// <int> The weight of interest in this particular preference. (1 = good, -1 = poor).
	): bool					// RETURNS <bool> TRUE if exists, FALSE on failure.
