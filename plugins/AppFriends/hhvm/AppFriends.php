...
/****** Check if the target ID is a friend ******/
	...
	,	int $targetID		// <int> The UniID of the target to check if a friend.
...
/****** Get the total count of friends of a user ******/
	...
	): int							// RETURNS <int> the total friend count of a user.
...
/****** Check if a user has already requested friendship with another user ******/
	...
	): array <str, int>					// RETURNS <str:int> the clearance levels of the request, array() if there is no request.
...
/****** Check what clearance levels a user has permitted a friend ******/
	...
	(
		int $uniID					// <int> The UniID of the user to check the role of.
	,	int $friendID				// <int> The UniID of the friend.
	): array <int, int>							// RETURNS <int:int> the friend's clearance levels, FALSE on failure.
...
/****** Set a relationship with a friend ******/
	...
	,	int $friendID				// <int> The Friend's UniID (or person requesting to be a friend, if need approval).
	,	int $viewClearance 			// <int> The level of view clearance being set.
	,	int $interactClearance		// <int> The level of interaction clearance being set.
...
/****** Send a friend request ******/
	...
	,	int $viewClearance = 5 		// <int> The level of view clearance being set.
	,	int $interactClearance = 5	// <int> The level of interaction clearance being set.
...
/****** Delete a friend ******/
	...
	(
		int $uniID					// <int> The User's UniID.
	,	int $friendID				// <int> The Friend's UniID.
	): bool							// RETURNS <bool> TRUE if the friend was deleted, FALSE on failure.
